...
texreg(first_stage_deter,
    ...
    custom.header = list("\\% Upstream Forest" = 1:4),
...
texreg(
    ...
    file = "output/tables/reg_deforestation_DETER_hosp_rate_subsets.tex",
...
texreg(
    ...
    custom.note = "\\item \\textit{Notes:} I estimate Maximum Likelihood Spatial Error Data Models with a Within Transformation. Health Outcomes are regressed on (instrumented) Forest Cover. Models include municipality and region-year fixed effects. Significance: %stars",
    booktabs = TRUE,
    use.packages = FALSE,
    threeparttable = TRUE,
    scalebox = .8,
